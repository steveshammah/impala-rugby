...
const index = () => {
  ...
  return (
    <div className="text-blackX flex flex-col items-center justify-around ">
      <div className="py-2 to-blackX lg:w-10/12 w-11/12">
        {activeVideo ? (
          <div className="flex justify-between h-[400px] bg-blackX relative">
            ...
            <div className="player-container">
              <div className="flex w-full flex-wrap justify-around">
                {videos.map((video, index) => (
                  <div
                    className="flex flex-col shadow-md w-[270px] bg-blackX h-[220px] rounded-md mb-6"
                    key={index}
                  >
                    <div
                      className="h-[80%] w-[100%] relative rounded-t-md"
                    ...
                    <div className="flex flex-col w-full px-2 bg-white rounded-b-md">
                      <h2 className="text-blackX font-bold uppercase text-md">
                        {replacer(video.snippet.title)}
                      </h2>
                      <span className="text-whiteX text-sm">Latest</span>
                    </div>
                  </div>
                ))}
              </div>
